...
def stage_mean_diff(dataframe, plot= False, figsize= (10, 6), use_col= 0, stage2_start = 30, stage3_start = 90, stage_end = 160):
    ...
    # Return:
    #     Tuple: 
    #         Tuple[0] : List of mean diff (2*6) or activation (1*6)
    #         Tuple[1] : List of index
    #=======================
...
def stage_begin_slope_diff(dataframe):
    ...
    # Return:
    #     Tuple: 
    #         Tuple[0] : List of slope diff (1*3)
    #         Tuple[1] : List of index
    #=======================
    ...
    col_set = []
    for col in dataframe.columns:
        col_set.append(col + "_Task_Recovery_begin_slope_diff")

    slope_diff = np.array(slope12) - np.array(slope34)

    return list(slope_diff), col_set
